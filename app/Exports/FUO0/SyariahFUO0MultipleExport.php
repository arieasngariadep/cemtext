...
class SyariahFUO0MultipleExport extends DefaultValueBinder implements FromCollection, WithHeadings, WithCustomValueBinder, WithColumnFormatting, WithTitle
{
    private $no_file;
    private $userId;
    ...
    */
    ...
    {
        $data = CemtextModel::getDataSyariahFuo0MultipleExport($this->no_file, $this->userId);
    ...
    {
        $tanggal = CemtextModel::getTanggalReportSyariahFUO0Multiple($this->no_file, $this->userId);
