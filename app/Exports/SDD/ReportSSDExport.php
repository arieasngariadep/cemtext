...
class ReportSSDExport extends DefaultValueBinder implements FromQuery, WithHeadings, WithCustomValueBinder
{
    /**
    ...
    */
    ...
    {
        $data = CemtextModel::getDataReportSDDExport($this->userId);
