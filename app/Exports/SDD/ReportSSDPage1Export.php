...
class ReportSSDPage1Export extends DefaultValueBinder implements FromCollection, WithHeadings, WithCustomValueBinder
{
    /**
    ...
    */
    ...
    {
        $data = CemtextModel::getDataReportSDDPage1Export($this->userId);
