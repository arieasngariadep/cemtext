...
class ReportSSDPage3Export extends DefaultValueBinder implements FromCollection, WithHeadings, WithCustomValueBinder
{
    /**
    ...
    */
    ...
    {
        $data = CemtextModel::getDataReportSDDPage3Export($this->userId);
