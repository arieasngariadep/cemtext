...
@section('title', 'Upload File Giro')
@section('titleTab', 'Upload File Giro Internal')
    ...
    <div class="col-xl-12 justify-content-center">
        <div class="card">
            <div class="card-body col-xl-11 ml-5">
                <h4 class="mt-0 header-title">Form Upload Giro Internal</h4>
                <?= $alert ?>
                <form action="<?= route('prosesUploadGiroInternal') ?>" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
