...
@section('title', 'Upload File RC')
@section('titleTab', 'Upload File RC')
    ...
    <div class="col-xl-12 justify-content-center">
        <div class="card">
            <div class="card-body col-xl-11 ml-5">
                <h4 class="mt-0 header-title">Form Upload Summary RC</h4>
                <?= $alert ?>
                <form action="<?= route('prosesUploadSumamryRC') ?>" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
