...
<script src="{{ asset('assets') }}/npm/sweetalert2@9.js"></script>

<!-- Highchart 3D PIE Javascript -->
...
<script src="{{ asset('assets') }}/modules/export-data.js"></script>
<script src="{{ asset('assets') }}/modules/accessibility.js"></script>
@include('js.user')
